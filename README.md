...
`pornhub_dl.py playlist [playlist_id]` Follow this playlist and download all videos.  
`pornhub_dl.py channel [channel_id]` Follow this channel and download all videos.  
`pornhub_dl.py video [vkey]` Download a single video by viewkey e.g. `1598008994`.  
`pornhub_dl.py update` Get the newest videos of all your followed models, playlists and channels.  
`pornhub_dl.py reset` Reschedule all files for download. Useful if you got your hands on a premium account ;) 
